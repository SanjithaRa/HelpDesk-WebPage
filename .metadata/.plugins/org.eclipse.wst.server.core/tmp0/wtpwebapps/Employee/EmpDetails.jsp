                ...
                <tr>
                    ...
                    <td>
                        <c:url value="updateEmployee.jsp" var="empupdate">
                            ...
                            <c:param name="age" value="${employee.age}"/>
                            <c:param name="experience" value="${employee.experience}"/>
                            <c:param name="position" value="${employee.position}"/>
                            <c:param name="email" value="${employee.email}"/>
                            <c:param name="pnum" value="${employee.pnum}"/>
                        </c:url>
                        <a href="${empupdate}">
